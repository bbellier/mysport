...
---
title: Coralie (Le coq)
subtitle: Ils ont réussi car ils ne savaient pas que c'était impossible. 
image: 'img/profil_photo//coralie.jpg'
toc: false
about:
  template: trestles
  links:
  - icon: 'bi bi-strava'
    text: Strava
    href: 'https://www.strava.com/athletes/126506004?oq=coral'
---

## Performance de Coralie

```{r, include = FALSE}
# Charger le script externe contenant l'analyse
source('C:/Users/bbell/Desktop/mysport/function_profil_stat.R')

# Exécuter l'analyse pour Coralie
name <- 'Coralie'
